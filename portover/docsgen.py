...
_LANG = {"pip-to-uv": ("text", "toml"), "jenkins-to-gha": ("groovy", "yaml"),
         "travis-to-gha": ("yaml", "yaml"), "gitlab-ci-to-gha": ("yaml", "yaml"), "circleci-to-gha": ("yaml", "yaml"), "azure-pipelines-to-gha": ("yaml", "yaml"), "bitbucket-to-gha": ("yaml", "yaml"), "buildkite-to-gha": ("yaml", "yaml"),
