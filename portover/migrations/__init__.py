...
from portover.migrations.woodpecker_to_gha import MIGRATION as woodpecker_to_gha
...
REGISTRY = [pip_to_uv, jenkins_to_gha, travis_to_gha, circleci_to_gha, gitlab_ci_to_gha, azure_pipelines_to_gha, bitbucket_to_gha, buildkite_to_gha, drone_to_gha, woodpecker_to_gha, flake8_to_ruff]
